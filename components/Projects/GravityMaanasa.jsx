...
const GravityMaanasa = () => {
	...
	return (
		<>
			<div className={`gravityBgProject-html ${projectStyle.gravityBgProject} ${projectStyle.gavityMaanasaBg}`} style={{ backgroundImage: 'url(/images/projects/mn/MN_BANNER_1.webp)', backgroundSize: '100% 110.955%', backgroundPosition: '0px -12.575px' }}>
					...
					<Row className={`justify-content-between align-items-md-end ${projectStyle.projectsRow}`}>
						<Col sm={12} md={6} className='order-last order-md-first'>
							<div className={projectStyle.projectLogoFlex}>
								<div className={`ps-0 pb-0 ${projectStyle.projectLogoMda}`}>
									<Image src='/images/maanasa-logo.png' className='img-fluid' alt='Smera Gardens' width='147' height='56' />
								</div>
						...
						<Col sm={12} md={6} className='order-first order-md-last align-items-center d-flex align-items-md-center justify-content-md-end'>
							<h2 className='text-white'>
								<span>Where Your Soul  </span> Lies in Nature
							</h2>
						</Col>
					</Row>
			...
			<div className={`gravityBgProject-html ${projectStyle.projectInfoHighlights}`}>
						...
						<Row className='justify-content-between'>
							...
							<Col sm={12} md={5} lg={4} className='order-last order-md-0'>
								<div className={`mb-4 ${projectStyle.aboutHighlightedLocat}`}>
									...
									<div className={` ${projectStyle.aboutHighlightedAdr}`}>
										<span>67, Kanakapura Rd, Paramount Gardens,</span>
										<span>Talaghattapura, Bengaluru</span>
									</div>
									<div className={` ${projectStyle.aboutHighlightedIco}`}>
										<span>
							...
							<Col sm={12} md={6} lg={7}>
								<div className={`mb-2 ${projectStyle.overViewTxt} ${projectStyle.overViewTxttext}`}>
									<h1 className={` ${projectStyle.fontFamilyAvenir}`}>Gravity Manaasa Nilayam - Overview</h1>

									<p className='mb-0'>Despite navigating through narrow pathways, the luxury villa community of Gravity Manaasa Nilayam established along Kanakapura-Main Road received widespread appreciation for overcoming spatial challenges. A highlight of the project lies in its use of innovative materials, notably the renowned Mangalore bricks which deliver enhanced durability and a unique aesthetic. Additionally, we also incorporated indoor skylights,infusing your home with quality daylight for a harmonious indoor-outdoor experience.</p>
								</div>
				...
				<div className={`position-relative w-100`}>
					<div className='spacer-5' />
					<div className={`position-relative w-100 ${projectStyle.ecoVillas} ${projectStyle.ecoVillasMn}`} style={{ backgroundImage: 'url(/images/projects/mn/MN_BANNER_MID_1.webp)' }}>
						...
						<Row className='justify-content-center'>
									...
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src='/images/projects/mn/1MN.webp' className='img-fluid' alt='Maanasa-1' fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src='/images/projects/mn/2MN.webp' className='img-fluid' alt='Maanasa-2' fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src='/images/projects/mn/3MN.webp' className='img-fluid' alt='Maanasa-3' fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src="/images/projects/mn/4MN.webp" className="img-fluid" alt="Maanasa-4" fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src="/images/projects/mn/5MN.webp" className="img-fluid" alt="Maanasa-5" fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src="/images/projects/mn/6MN.webp" className="img-fluid" alt="Maanasa-6" fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src="/images/projects/mn/7MN.webp" className="img-fluid" alt="Maanasa-7" fill={true} />
											</div>
										</div>
									</SwiperSlide>
									<SwiperSlide>
										<div className="carousel-flex">
											<div className="carousel-media position-relative">
												<Image src="/images/projects/mn/8MN.webp" className="img-fluid" alt="Maanasa-8" fill={true} />
											</div>
										</div>
									</SwiperSlide>
								</Swiper>
							...
							<Col sm={12} md={10} className='px-0 px-md-3'>
								<div className={`video ${livingStyles.videoGalleryDiv} ${projectStyle.videoGalleryDv}`}>
									<video src='https://gravityhomes.objectstore.e2enetworks.net/videos/Gravity_Manasa_Nilayam.mp4' controls='controls' ref={videoRef} type="video/mp4" autoPlay={false} loop={true} />
