		...
		<>
			<Accordion defaultActiveKey={['0']} alwaysOpen>
				<Accordion.Item eventKey="0">
					<Accordion.Header className='faq-ques'>What is the starting price of Gravity Smera Gardens?</Accordion.Header>
					<Accordion.Body>
				...
				<Accordion.Item eventKey="1">
					<Accordion.Header className='faq-ques'>What is Gravity’s history, mission and vision?</Accordion.Header>
					<Accordion.Body>
				...
				<Accordion.Item eventKey="2">
					<Accordion.Header className='faq-ques'>How are you committed to the community and environment?</Accordion.Header>
					<Accordion.Body>
